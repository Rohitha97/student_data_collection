<?php include "./assets/CountryCodes.php"; ?>
<!DOCTYPE html>
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="row bg-white py-3" style="padding: 10px; text-align: center">
                                        <div class="col-sm-3">
                                            <h3 class="nk-block-title page-title">Student Data Collection</h3>
                                        </div>
                                        <div class="col-sm-5"></div>
                                        <div class="col-sm-1"><img src="./student_data_collection/images/logo.png" width="50px" /></div>
                                        <div class="col-sm-3">
                                        ...
                                        <div class="row g-gs">
                                            <div class="nk-block nk-block-lg">
                                                <div class="card card-preview">
                                                    <div class="card-inner">
                                                        <div class="preview-block">
                                                            ...
                                                            <div class="row gy-4">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="first_name">Student's first name <span class="text-danger">*</span></label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="last_name">Student's last name <span class="text-danger">*</span></label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="codice_fliscale">Student's codice fiscale <span class="text-danger">*</span></label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-12 col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="complete_name">Student's complete name (for the certificates) <span class="text-danger">*</span></label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-4">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="student_passport">Student's passport <span class="text-danger">*</span></label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="mobile_number">Student's mobile number</label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="student_email">Student's email <span class="text-danger">*</span></label>
                                                                        <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-4 row mt-4">
                                                                    <label class="form-label">Does the student has any siblings? <span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-sm-6 col-md-4" id="siblings_count">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="">If yes, how many sisters/ brothers does the student has?</label>
                                                                        <div class="form-control-wrap">
                                                            ...
                                                            <div class="row gy-4">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" maxlength="10" class="form-control" id="father_phone" name="father_phone" placeholder="Father's phone">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" maxlength="10" class="form-control" id="father_whtsapp" name="father_whtsapp" placeholder="Father's whatsapp no">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" maxlength="10" id="" name="father_viber" placeholder="Father's viber no">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-4">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="default-1-02">Father's occupation</label>
                                                                        <input type="text" class="form-control" id="default-1-02" name="father_occupation" placeholder="Father's occupation">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6 col-md-4">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="default-1-02">Mother's codice fiscale</label>
                                                                        <input type="text" class="form-control" id="default-1-02" name="mother_codice_fiscale" placeholder="Mother's codice fiscale">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-4">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="default-1-02">Mother's passport no</label>
                                                                        <input type="text" class="form-control" id="default-1-02" name="mother_passport_no" placeholder="Mother's passport no">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row gy-4 mt-3">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" maxlength="10" id="" name="guardian_phone" placeholder="Guardian's name">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" maxlength="10" id="" name="guardian_whtsapp" placeholder="Guardian's whatsapp no">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6 col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" maxlength="10" id="" name="guardian_viber" placeholder="Guardian's viber no">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6 col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="default-1-02">Guardian's occupation <span class="text-danger">*</span></label>
                                                                        <input type="text" class="form-control" id="guaridan_occupation" name="guaridan_occupation" placeholder="Guardian's occupation">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="text-end py-4 px-3">
                                                        <button class="btn btn-success text-center px-5 border" id="submit" type="submit" name="submit">Submit</button>
                                                    </div>
                                                </div><!-- .card-preview -->
                                            </div><!-- .code-block -->
                                        </div><!-- .nk-block -->
            ...
            <div class="nk-footer">
                <div class="container-fluid">
                    <div class="nk-footer-wrap">
                        <div class="nk-footer-copyright"> &copy; 2022 Dbeeta Software Solutions.</a>
                        </div>
    ...
    <script>
        ...
        function validate() {
            ...
            if (document.student_data.grade.value == "") {
                document.getElementById('une').innerHTML = "Please select student class!";
                document.student_data.grade.focus();
                return false;
            }
